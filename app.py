...
# Key for storing current user in session
CURR_USER_KEY = "curr_user"

app = Flask(__name__)

# Configure the Flask app with database URI and other settings
...
@app.route('/users')
def list_users():
    """Page with listing of users. Can take a 'q' param in querystring to search by that username."""
...
def homepage():
    ...
    """
    if g.user:
        followed_users_ids = [u.id for u in g.user.following] + [g.user.id]
        messages = (Message
                    .query
